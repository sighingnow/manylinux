...
docker buildx build --platform linux/amd64,linux/arm64 --push --build-arg POLICY --build-arg BASEIMAGE --build-arg DEVTOOLSET_ROOTPATH --build-arg PREPEND_PATH --build-arg LD_LIBRARY_PATH_ARG -t registry.cn-hongkong.aliyuncs.com/graphscope/manylinux2014:20230407 -f docker/Dockerfile docker/
